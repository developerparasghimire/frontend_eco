...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'High-efficiency solar panels, inverters and batteries for home and business. Shop online with fast delivery across India.',
    url: '/products',
    type: 'website',
  },
  twitter: {
    ...
    description: 'High-efficiency solar panels, inverters and batteries. Fast delivery across India.',
  },
};
